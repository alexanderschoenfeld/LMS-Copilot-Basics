...
Gehe die Übungen in dieser Reihenfolge durch, um die Unterschiede zwischen iterativem Prompting und One-Shot-Prompting zu erkennen:
   ...
   3. Few-Shot: [uebung-few-shot-prompting.md](Modul%204%20Copilot%20Prompting/uebung-few-shot-prompting.md)
   4. Deterministisch (Chain-of-Thought): [LehrerLaempelPrompt.md](Modul%204%20Copilot%20Prompting/LehrerLaempelPrompt.md)
   5. Kundenservice: [uebung-email-analyse-antwortentwurf.md](Modul%204%20Copilot%20Prompting/uebung-email-analyse-antwortentwurf.md)
